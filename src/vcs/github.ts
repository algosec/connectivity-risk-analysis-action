...
export class Github implements IVersionControl {
  ...
  buildCommentAnalysisBody(
    ...
    if (!analysis?.additions) {
      analysisBody = `<details>\n < summary > <sub><sub><sub><a href="#" > <img  height="20" width = "20" src = "${this.assetsUrl
        }/failure.svg" / > </a></sub > </sub></sub >& nbsp;& nbsp; <h3><b>${file.folder
      ...
      analysisBody = `<details>\n<summary><sub><sub><sub><a href="#"><img  height="20" width="20" src="${this.assetsUrl
        }/success.svg" /></a></sub></sub></sub>&nbsp;&nbsp;<h3><b>${file.folder
        }</b></h3></summary>\n${this.buildCommentFrameworkResult(
          file
        )}\n</details>`;
    } else {
  ...
  buildCommentReportResult(
    ...
    analysis?.analysis_result?.sort(
      ...
      .forEach((risk) => {
        risksList += `<details>\n
<summary><a href="#"><img  width="10" height="10" src="${this.assetsUrl}/${risk.riskSeverity
...
${risk?.items?.map(item =>
  ...
  <td>${item?.ipRange ?? ''}</td>\n
    ...
    const codeAnalysisContent = `<summary><sub><sub><sub><a href="#"><img  height="20" width="20" src="${this.assetsUrl
      }/warning.svg" /></a></sub></sub></sub>&nbsp;&nbsp;<h3><b>${file.folder +
...
<td>${risk.riskId}</td>\n
<td align="center"><a href="#"><img  width="10" height="10" src="${this.assetsUrl}/${risk?.riskSeverity
        }.svg" /></a></td>\n
<td align="center"><sub><a href="#"><img  width="24" height="24" src="${this.assetsUrl}/${risk?.vendor?.toLowerCase() ?? "aws"
        }.svg" /></a></sub></td>\n
