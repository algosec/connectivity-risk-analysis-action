...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if ((analysisResult === null || analysisResult === void 0 ? void 0 : analysisResult.length) == 0) {
                (0, core_1.info)('Risk Analysis Completed with no risks found');
...
function parseRiskAnalysis(octokit, git, riskAnalysis, terraform) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, core_1.info)('Parsing Report');
        const body = parseToGithubSyntax(riskAnalysis, terraform);
        git.createComment(body, octokit, github_1.context);
        return;
    });
}
...
function checkRiskAnalysisResponse() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (message_found) {
            ...
            if (parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.success) {
                const riskAnalysis = (_a = parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.additions) === null || _a === void 0 ? void 0 : _a.analysis_result;
                const analysisState = (_b = parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.additions) === null || _b === void 0 ? void 0 : _b.analysis_state;
                if (analysisState && (riskAnalysis === null || riskAnalysis === void 0 ? void 0 : riskAnalysis.length) == 0) {
                    (0, core_1.info)('The risks analysis process completed successfully without any risks');
                }
                else {
                    (0, core_1.info)('The risks analysis process completed successfully with risks, please check report');
                }
                return riskAnalysis;
            }
            else {
                (0, core_1.setFailed)('The risks analysis process completed with errors, please check report');
            }
        }
    });
}
