...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (gotResponse === null || gotResponse === void 0 ? void 0 : gotResponse.success) {
...
function checkRiskAnalysisResponse() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (message_found) {
            ...
            if ((parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.success) && ((_a = parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.additions) === null || _a === void 0 ? void 0 : _a.analysis_state)) {
                let riskAnalysis = (_b = parsedResult === null || parsedResult === void 0 ? void 0 : parsedResult.additions) === null || _b === void 0 ? void 0 : _b.analysis_result;
                if ((riskAnalysis === null || riskAnalysis === void 0 ? void 0 : riskAnalysis.length) > 0) {
                    (0, core_1.info)('The risks analysis process completed successfully: \n' + JSON.stringify(riskAnalysis));
                    return riskAnalysis;
                }
                else {
