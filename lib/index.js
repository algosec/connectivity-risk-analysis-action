...
github_1.context.payload = mockData_1.githubEventPayloadMock;
...
const tenantId = (_e = process === null || process === void 0 ? void 0 : process.env) === null || _e === void 0 ? void 0 : _e.TENANT_ID;
const clientId = (_f = process === null || process === void 0 ? void 0 : process.env) === null || _f === void 0 ? void 0 : _f.CF_CLIENT_ID;
const clientSecret = (_g = process === null || process === void 0 ? void 0 : process.env) === null || _g === void 0 ? void 0 : _g.CF_CLIENT_SECRET;
const loginAPI = (_h = process === null || process === void 0 ? void 0 : process.env) === null || _h === void 0 ? void 0 : _h.CF_LOGIN_API;
const actionUuid = getUuid(ghSha);
const githubWorkspace = (_j = process === null || process === void 0 ? void 0 : process.env) === null || _j === void 0 ? void 0 : _j.GITHUB_WORKSPACE; //+'_'+actionUuid
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (200 <= response_code && response_code <= 300) {
                ...
                (0, core_1.setFailed)(`Failed to generate token. Error code ${response_code}, msg: ${data}`);
            }
        }
        catch (error) {
            (0, core_1.setFailed)(`Error: ${error.toString()}`);
        }
        return '';
    });
}
