...
const githubWorkspace = (_e = process === null || process === void 0 ? void 0 : process.env) === null || _e === void 0 ? void 0 : _e.GITHUB_WORKSPACE; //+'_'+actionUuid
...
function terraform(diffFolder) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            steps.setupVersion = yield exec('curl', ['-L', 'https://raw.githubusercontent.com/warrensbox/terraform-switcher/release/install.sh', '|', 'bash']);
            (0, core_1.info)('##### Algosec ##### tfswitch Installed successfully');
            if (((_a = process === null || process === void 0 ? void 0 : process.env) === null || _a === void 0 ? void 0 : _a.TF_VERSION) == "latest" || ((_b = process === null || process === void 0 ? void 0 : process.env) === null || _b === void 0 ? void 0 : _b.TF_VERSION) == "") {
                steps.switchVersion = yield exec('tfswitch', ['--latest']);
            }
            else {
                steps.switchVersion = yield exec('tfswitch', []);
            }
            (0, core_1.info)('##### Algosec ##### tfswitch version: ' + ((_c = process === null || process === void 0 ? void 0 : process.env) === null || _c === void 0 ? void 0 : _c.TF_VERSION));
...
function uploadFile(json) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let res = false;
        if (json) {
            const ans = yield aws.uploadToS3(actionUuid, JSON.stringify(json));
            if (ans) {
                res = true;
            }
        }
...
function initRiskAnalysis(diff) {
    return __awaiter(this, void 0, void 0, function* () {
        const steps = {};
        ...
        let analysisResult;
        const fileUploaded = yield uploadFile(terraformResult === null || terraformResult === void 0 ? void 0 : terraformResult.plan);
