...
Output\n
${CODE_BLOCK}json\n
${JSON.stringify(analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result)}\n
${CODE_BLOCK}\n
...
## ${((_b = terraform === null || terraform === void 0 ? void 0 : terraform.log) === null || _b === void 0 ? void 0 : _b.stdout) ? ':heavy_check_mark:' : ':x:'} Terraform Processing ⚙️\n
<details>
...
Errors\n
${CODE_BLOCK}\n
${(_d = terraform === null || terraform === void 0 ? void 0 : terraform.log) === null || _d === void 0 ? void 0 : _d.stderr}\n
${CODE_BLOCK}\n
</details> <!-- End Format Logs -->\n
*Pusher: @${github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.actor}, Action: \`${github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.eventName}\`, Working Directory: \'${'tf_actions_working_dir'}\', Workflow: \'${github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.workflow}\'*`;
    return output;
}
