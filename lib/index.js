...
const apiUrl = (0, core_1.getInput)('RA_API_URL'); // process.env.API_URL ?? getInput('TF_API_TOKEN')
const s3Dest = (0, core_1.getInput)('AWS_S3'); // process?.env?.S3_DEST ?? getInput('S3_DEST')
...
function pollRiskAnalysisResponse() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let hResult = yield checkRiskAnalysisResponse(http);
        let i = 0;
        while (i < 50) {
            yield wait(1000);
            hResult = yield checkRiskAnalysisResponse(http);
            i++;
        }
        return hResult;
    });
...
function checkRiskAnalysisResponse(http) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (message_found) {
            ...
            if ((analysis === null || analysis === void 0 ? void 0 : analysis.success) && analysis.additions.analysis_state) {
            ...
            if (message_found && analysis_result) {
                if (analysis.additions) {
                    (0, core_1.info)('Additions: ' + analysis.additions);
                }
