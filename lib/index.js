...
function terraform(diff, tfToken = '') {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // const diffPromises = []
            if (tfToken) {
...
## <sup>Terraform Processing &nbsp; ${((_b = terraform === null || terraform === void 0 ? void 0 : terraform.log) === null || _b === void 0 ? void 0 : _b.stdout) ? ':heavy_check_mark:' : ':x:'}<sup>\n
<details>
...
Errors\n
${CODE_BLOCK}\n
${terraform === null || terraform === void 0 ? void 0 : terraform.terraformLog.stderr}\n
${CODE_BLOCK}\n
</details> <!-- End Format Logs -->\n
</details>\n
*Pusher: @${github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.actor}, Action: \`${github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.eventName}\`, Working Directory: \'${'diff'}\', Workflow: \'${github_1.context === null || github_1.context === void 0 ? void 0 : github_1.context.workflow}\'*`;
    return output;
}
...
function run(context) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const clone = yield exec('gh', ['repo', 'clone', context.repo.owner + '/' + context.repo.repo, githubWorkspace]);
            // }
            process.chdir(githubWorkspace);
            const pr = yield exec('gh', ['pr', 'checkout', context.payload.pull_request.number.toString()]);
            // await loginToAws();
            const diffs = yield changedFiles(octokit, context, git);
            ...
            const terraformResult = yield terraform(diffs[0], tfToken);
            ...
            if (analysisResult === null || analysisResult === void 0 ? void 0 : analysisResult.success) {
                risks = analysisResult === null || analysisResult === void 0 ? void 0 : analysisResult.additions;
