...
function terraform(diffFolder) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const steps = {};
            steps.awsConfigureKey = yield exec('aws', ['configure', 'set', 'aws_access_key_id', awsKeyId]);
            steps.awsConfigureSecret = yield exec('aws', ['configure', 'set', 'aws_secret_access_key', awsSecretKey]);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!(0, fs_1.existsSync)(githubWorkspace)) {
                steps.gitClone = yield exec('git', ['clone', `https://${github_1.context.repo.owner}:${ghToken}@github.com/${github_1.context.repo.owner}/${github_1.context.repo.repo}.git`, githubWorkspace]);
            }
            process.chdir(githubWorkspace);
