...
class CodeAnalysis {
    ...
    uploadFile(file, jwt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (file === null || file === void 0 ? void 0 : file.output) {
                const ans = yield aws.uploadToS3(file === null || file === void 0 ? void 0 : file.uuid, JSON.stringify((_a = file === null || file === void 0 ? void 0 : file.output) === null || _a === void 0 ? void 0 : _a.plan), jwt);
                if (ans) {
                    res = true;
                }
            }
    ...
    checkCodeAnalysisResponse(file) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const pollUrl = `${this.apiUrl}?customer=${github_1.context.repo.owner}&action_id=${file.uuid}`;
