...
class CodeAnalysis {
    constructor() {
        ...
        this.apiUrl = (_b = process === null || process === void 0 ? void 0 : process.env) === null || _b === void 0 ? void 0 : _b.RA_API_URL;
        this.s3Dest = (_c = process === null || process === void 0 ? void 0 : process.env) === null || _c === void 0 ? void 0 : _c.AWS_S3;
        this.tenantId = (_d = process === null || process === void 0 ? void 0 : process.env) === null || _d === void 0 ? void 0 : _d.TENANT_ID;
        this.clientId = (_e = process === null || process === void 0 ? void 0 : process.env) === null || _e === void 0 ? void 0 : _e.CF_CLIENT_ID;
    ...
    triggerCodeAnalysis(filesToUpload, jwt) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    uploadFile(file, jwt) {
        return __awaiter(this, void 0, void 0, function* () {
            const aws = new aws_1.Aws(this.s3Dest);
            let res = false;
            if (file === null || file === void 0 ? void 0 : file.output) {
                const ans = yield aws.uploadToS3(file.folder, uuid.v4(), JSON.stringify(file.output), jwt);
                if (ans) {
                    res = true;
                }
            }
    ...
    getCodeAnalysis(foldersToRunCheck) {
        return __awaiter(this, void 0, void 0, function* () {
            let analysisResult;
            ...
            if (!analysisResult) {
                (0, core_1.setFailed)('##### Algosec ##### Code Analysis failed to due timeout');
                return;
            }
    ...
    pollCodeAnalysisResponse(folderName) {
        return __awaiter(this, void 0, void 0, function* () {
            let analysisResult = yield this.checkCodeAnalysisResponse(folderName);
            for (let i = 0; i < 50; i++) {
                yield this.wait(3000);
                analysisResult = yield this.checkCodeAnalysisResponse(folderName);
    ...
    checkCodeAnalysisResponse(folderName) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const pollUrl = `${this.apiUrl}?customer=${github_1.context.repo.owner}&action_id=${this.actionUuid}&folder_name=${folderName}`;
            const response = yield this.http.get(pollUrl);
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const jwt = yield this.auth(this.tenantId, this.clientId, this.clientSecret, this.loginAPI);
                if (!jwt || jwt == '') {
                ...
                yield this.triggerCodeAnalysis(filesToUpload, jwt);
                const codeAnalysisResponse = yield this.getCodeAnalysis(foldersToRunCheck);
                yield this.parseOutput(codeAnalysisResponse);
