...
const githubWorkspace = (_f = process === null || process === void 0 ? void 0 : process.env) === null || _f === void 0 ? void 0 : _f.GITHUB_WORKSPACE; //+'_'+actionUuid
...
function uploadFile(json) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let res = false;
        if (json) {
            const ans = yield aws.uploadToS3(tenantId, JSON.stringify(json));
            if (ans) {
                res = true;
            }
        }
