...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, core_1.info)('Diffs Result: ' + JSON.stringify(diffs));
            const terraformResult = yield terraform(diffs, tfToken);
            (0, core_1.info)('Terraform Result: ' + JSON.stringify(terraformResult));
            // const fileToUpload = s3File 
            let analysisResult;
            if (uploadFile(terraformResult.plan)) {
                (0, core_1.info)('File Uploaded to S3 Successfully');
                analysisResult = yield pollRiskAnalysisResponse();
            }
            (0, core_1.info)('Risk Analysis Result: ' + JSON.stringify(analysisResult));
            if ((_a = analysisResult === null || analysisResult === void 0 ? void 0 : analysisResult.result) === null || _a === void 0 ? void 0 : _a.success) {
                const risks = (_b = analysisResult === null || analysisResult === void 0 ? void 0 : analysisResult.result) === null || _b === void 0 ? void 0 : _b.additions;
