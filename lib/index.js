...
<td>${risk.riskTitle}</td>\n
    ...
    const terraformContent = `## <sup>Terraform Processing &nbsp; ${((_b = terraform === null || terraform === void 0 ? void 0 : terraform.log) === null || _b === void 0 ? void 0 : _b.stdout) ? ':heavy_check_mark:' : ':x:'}<sup>\n
<details>
...
Errors\n
${CODE_BLOCK}\n
${(_e = (_d = terraform === null || terraform === void 0 ? void 0 : terraform.log) === null || _d === void 0 ? void 0 : _d.stderr) !== null && _e !== void 0 ? _e : terraform.initLog.stderr}\n
${CODE_BLOCK}\n
...
${CODE_BLOCK}\n
    ...
    const markdownOutput = header +
        risksTable +
        `<details open="true">\n` +
        (((_f = analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result) === null || _f === void 0 ? void 0 : _f.length) > 0 ? riskAnalysisContent : 'No Risks Found') +
        terraformContent +
        `</details>\n` +
