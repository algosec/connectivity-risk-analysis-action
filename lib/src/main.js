...
const mockData_gcp_1 = require("../test/mockData.gcp");
class Main {
    constructor() {
        var _a, _b;
        this.steps = {};
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                //       filesToAnalyze
                //     );
                if ((mockData_gcp_1.codeAnalysisResponses === null || mockData_gcp_1.codeAnalysisResponses === void 0 ? void 0 : mockData_gcp_1.codeAnalysisResponses.length) > 0) {
                    yield vcs.parseOutput(mockData_gcp_1.filesToAnalyze, mockData_gcp_1.codeAnalysisResponses);
                }
                //   }
                // }
            }
