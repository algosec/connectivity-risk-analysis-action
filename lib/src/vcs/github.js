...
github_1.context.payload = mockData_gcp_1.githubEventPayloadMock;
class Github {
    constructor() {
...
<td align="center"><sub><img width="15" height="15" src="${this.assetsUrl}/${(_a = risk === null || risk === void 0 ? void 0 : risk.vendor.toLowerCase()) !== null && _a !== void 0 ? _a : "aws"}.svg" /></sub></td>\n
