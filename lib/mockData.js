...
exports.codeAnalysisMock = exports.terraformPlanFileMock = exports.terraformSinglePlanFileMock = exports.githubEventPayloadMock = void 0;
exports.githubEventPayloadMock = {
    "action": "synchronize",
    "after": "405834aef57d4209ea331af341c8c05ad67b1431",
    "before": "d839b5675ec6d7a6e9720d88f6e6026e63d3ddce",
    "number": 16,
    "organization": {
    ...
    "pull_request": {
        "_links": {
            "comments": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/issues/16/comments"
            },
            "commits": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/16/commits"
            },
            "html": {
                "href": "https://github.com/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pull/16"
            },
            "issue": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/issues/16"
            },
            "review_comment": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/comments{/number}"
            },
            "review_comments": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/16/comments"
            },
            "self": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/16"
            },
            "statuses": {
                "href": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/statuses/405834aef57d4209ea331af341c8c05ad67b1431"
            }
        },
        ...
        "base": {
            ...
            "repo": {
                ...
                "pushed_at": "2022-08-17T08:14:38Z",
                ...
                "updated_at": "2022-08-06T14:57:46Z",
            ...
            "sha": "849908296077064aea173043172d1b4c172c6be3",
            "user": {
                "avatar_url": "https://avatars.githubusercontent.com/u/110526486?v=4",
                "events_url": "https://api.github.com/users/alonnalgoDevSecOps/events{/privacy}",
                "followers_url": "https://api.github.com/users/alonnalgoDevSecOps/followers",
        ...
        "closed_at": null,
        "comments": 0,
        "comments_url": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/issues/16/comments",
        "commits": 2,
        "commits_url": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/16/commits",
        "created_at": "2022-08-16T13:19:34Z",
        "deletions": 2,
        "diff_url": "https://github.com/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pull/16.diff",
        "draft": false,
        "head": {
            "label": "alonnalgoDevSecOps:TEST-ABSTRACT",
            "ref": "TEST-ABSTRACT",
            "repo": {
                "allow_auto_merge": false,
                "allow_forking": true,
            ...
            "sha": "405834aef57d4209ea331af341c8c05ad67b1431",
            "user": {
                "avatar_url": "https://avatars.githubusercontent.com/u/110526486?v=4",
                "events_url": "https://api.github.com/users/alonnalgoDevSecOps/events{/privacy}",
                "followers_url": "https://api.github.com/users/alonnalgoDevSecOps/followers",
        ...
        "html_url": "https://github.com/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pull/16",
        "id": 1027617267,
        "issue_url": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/issues/16",
        "labels": [],
        "locked": false,
        "maintainer_can_modify": false,
        "merge_commit_sha": "11666666273e5d6f16d7d9370d474a15ed1c60c7",
        "mergeable": null,
        ...
        "merged_by": null,
        "milestone": null,
        "node_id": "PR_kwDOHwqgWc49QDHz",
        "number": 16,
        "patch_url": "https://github.com/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pull/16.patch",
        "rebaseable": null,
        "requested_reviewers": [],
        "requested_teams": [],
        ...
        "review_comments": 0,
        "review_comments_url": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/16/comments",
        "state": "open",
        "statuses_url": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/statuses/405834aef57d4209ea331af341c8c05ad67b1431",
        "title": "TEST ABSTRACT",
        "updated_at": "2022-08-17T08:14:38Z",
        "url": "https://api.github.com/repos/alonnalgoDevSecOps/risk-analysis-customer-repo-example/pulls/16",
        "user": {
...
exports.terraformSinglePlanFileMock = [
    {
        "uuid": "22493c1a-32d5-569e-9f82-ea41487a90bb",
        "folder": "tf-test",
        "output": {
            "plan": {
                "format_version": "1.1",
...
exports.terraformPlanFileMock = [
    {
        ...
        "output": {
            ...
            "log": {
                "stdout": "\nTerraform used the selected providers to generate the following execution\nplan. Resource actions are indicated with the following symbols:\n  + create\n\nTerraform will perform the following actions:\n\n  # aws_cloudfront_distribution.cloudfront_distribution will be created\n  + resource \"aws_cloudfront_distribution\" \"cloudfront_distribution\" {\n      + arn                            = (known after apply)\n      + caller_reference               = (known after apply)\n      + default_root_object            = \"index.html\"\n      + domain_name                    = (known after apply)\n      + enabled                        = true\n      + etag                           = (known after apply)\n      + hosted_zone_id                 = (known after apply)\n      + http_version                   = \"http2\"\n      + id                             = (known after apply)\n      + in_progress_validation_batches = (known after apply)\n      + is_ipv6_enabled                = false\n      + last_modified_time             = (known after apply)\n      + price_class                    = \"PriceClass_All\"\n      + retain_on_delete               = false\n      + status                         = (known after apply)\n      + tags_all                       = (known after apply)\n      + trusted_key_groups             = (known after apply)\n      + trusted_signers                = (known after apply)\n      + wait_for_deployment            = true\n\n      + default_cache_behavior {\n          + allowed_methods        = [\n              + \"DELETE\",\n              + \"GET\",\n              + \"HEAD\",\n              + \"OPTIONS\",\n              + \"PATCH\",\n              + \"POST\",\n              + \"PUT\",\n            ]\n          + cached_methods         = [\n              + \"GET\",\n              + \"HEAD\",\n            ]\n          + compress               = false\n          + default_ttl            = 3600\n          + max_ttl                = 86400\n          + min_ttl                = 0\n          + target_origin_id       = \"this-is-a-test\"\n          + trusted_key_groups     = (known after apply)\n          + trusted_signers        = (known after apply)\n          + viewer_protocol_policy = \"redirect-to-https\"\n\n          + forwarded_values {\n              + headers                 = (known after apply)\n              + query_string            = false\n              + query_string_cache_keys = (known after apply)\n\n              + cookies {\n                  + forward           = \"none\"\n                  + whitelisted_names = (known after apply)\n                }\n            }\n        }\n\n      + logging_config {\n          + include_cookies = false\n          + prefix          = \"logs\"\n        }\n\n      + origin {\n          + connection_attempts = 3\n          + connection_timeout  = 10\n          + domain_name         = \"this-is-a-test\"\n          + origin_id           = \"this-is-a-test/cloudflow\"\n        }\n\n      + restrictions {\n          + geo_restriction {\n              + locations        = (known after apply)\n              + restriction_type = \"none\"\n            }\n        }\n\n      + viewer_certificate {\n          + minimum_protocol_version = \"TLSv1\"\n          + ssl_support_method       = \"sni-only\"\n        }\n    }\n\n  # aws_security_group.devsecops_test will be created\n  + resource \"aws_security_group\" \"devsecops_test\" {\n      + arn                    = (known after apply)\n      + description            = \"Display devsecops \"\n      + egress                 = [\n          + {\n              + cidr_blocks      = [\n                  + \"0.0.0.0/0\",\n                ]\n              + description      = \"\"\n              + from_port        = 7654\n              + ipv6_cidr_blocks = []\n              + prefix_list_ids  = []\n              + protocol         = \"tcp\"\n              + security_groups  = []\n              + self             = false\n              + to_port          = 7655\n            },\n        ]\n      + id                     = (known after apply)\n      + ingress                = [\n          + {\n              + cidr_blocks      = [\n                  + \"172.31.0.0/16\",\n                ]\n              + description      = \"web app\"\n              + from_port        = 8080\n              + ipv6_cidr_blocks = []\n              + prefix_list_ids  = []\n              + protocol         = \"tcp\"\n              + security_groups  = []\n              + self             = false\n              + to_port          = 8082\n            },\n        ]\n      + name                   = \"devsecops_test\"\n      + name_prefix            = (known after apply)\n      + owner_id               = (known after apply)\n      + revoke_rules_on_delete = false\n      + tags                   = {\n          + \"Name\" = \"cool_application\"\n        }\n      + tags_all               = {\n          + \"Name\" = \"cool_application\"\n        }\n      + vpc_id                 = \"vpc-12345678\"\n    }\n\nPlan: 2 to add, 0 to change, 0 to destroy.\n\nChanges to Outputs:\n  + domain_name = (known after apply)\n\n─────────────────────────────────────────────────────────────────────────────\n\nSaved the plan to: C:\\git\\risk-analysis-action\\test-repo_e2cf4cdc-e4f7-58d7-a6fa-8cc754057d3a\\tf-test-1\\tmp\\tf-tf-test-1.out\n\nTo perform exactly these actions, run the following command to apply:\n    terraform apply \"C:\\\\git\\\\risk-analysis-action\\\\test-repo_e2cf4cdc-e4f7-58d7-a6fa-8cc754057d3a\\\\tf-test-1\\\\tmp\\\\tf-tf-test-1.out\"\n",
                "stderr": "",
                "code": 0
            },
            "initLog": {
...
exports.codeAnalysisMock = [
    {
        "proceeded_file": "tmp_ABCDEFG.out",
        "success": true,
        "additions": {
            "analysis_state": true,
            "analysis_result": []
    ...
    {
        "proceeded_file": "tmp_HIJKLMNO.out",
        "success": true,
        "additions": {
            "analysis_state": true,
            "analysis_result": [
