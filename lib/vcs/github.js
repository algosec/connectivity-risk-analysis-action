...
class Github {
    ...
    buildCommentAnalysisBody(analysis, file) {
        ...
        if (!(analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result)) {
            analysisBody = `<details>\n<summary><sub><sub><sub><img href="#" height="20" width="20" src="${this.assetsUrl}/failure.svg" /></sub></sub></sub>&nbsp;&nbsp;<h3><b>${file.folder}</b></h3></summary>\n${this.buildCommentFrameworkResult(file)}\n</details>`;
        }
        else if (((_a = analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result) === null || _a === void 0 ? void 0 : _a.length) == 0) {
            analysisBody = `<details>\n<summary><sub><sub><sub><img href="#" height="20" width="20" src="${this.assetsUrl}/success.svg" /></sub></sub></sub>&nbsp;&nbsp;<h3><b>${file.folder}</b></h3></summary>\n${this.buildCommentFrameworkResult(file)}\n</details>`;
        }
        else {
    ...
    buildCommentReportResult(analysis, file) {
        ...
        analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result.sort((a, b) => parseInt(risk_model_1.severityOrder[a.riskSeverity]) -
            ...
            risksList += `<details>\n
<summary><img href="#" width="10" height="10" src="${this.assetsUrl}/${risk.riskSeverity}.svg" />  ${risk.riskId}</summary> \n
### **Title:**\n${risk.riskTitle}\n
...
${CODE_BLOCK}\n
        ...
        const severityCount = `<div  align="right">${(0, exec_2.count)(analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result, "riskSeverity", "critical") > 0
            ? `<img href="#" width="10" height="10" src="${this.assetsUrl}/critical.svg" />&nbsp;` +
            ...
            ? `&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img href="#" width="10" height="10" src="${this.assetsUrl}/high.svg" />&nbsp;` +
            ...
            ? `&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img href="#" width="10" height="10" src="${this.assetsUrl}/medium.svg" />&nbsp;` +
            ...
            ? `&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img href="#" width="10" height="10" src="${this.assetsUrl}/low.svg" />&nbsp;` +
                (0, exec_2.count)(analysis === null || analysis === void 0 ? void 0 : analysis.analysis_result, "riskSeverity", "low") +
                "&nbsp;Low"
            : ""}</div>`;
        const codeAnalysisContent = `<summary><sub><sub><sub><img href="#" height="20" width="20" src="${this.assetsUrl}/warning.svg" /></sub></sub></sub>&nbsp;&nbsp;<h3><b>${file.folder +
...
<td>${risk.riskId}</td>\n
<td align="center"><img href="#" width="10" height="10" src="${this.assetsUrl}/${risk.riskSeverity}.svg" /></td>\n
<td align="center"><sub><img href="#" width="24" height="24" src="${this.assetsUrl}/${(_a = risk === null || risk === void 0 ? void 0 : risk.vendor.toLowerCase()) !== null && _a !== void 0 ? _a : "aws"}.svg" /></sub></td>\n
...
${risksTableContents}                 
    ...
    parseCodeAnalysis(filesToUpload, analysisResults) {
        ...
        const header = `<img href="#" height="50" src="${this.assetsUrl}/header.svg" /> \n`;
        const footer = `\n\n---\n\n
<br>
