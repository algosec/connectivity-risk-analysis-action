    ...
    parseOutput(filesToUpload, analysisResults, errorMessage, foldersToRunCheck) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ((analysisResults === null || analysisResults === void 0 ? void 0 : analysisResults.length) == 0 || (filesToUpload === null || filesToUpload === void 0 ? void 0 : filesToUpload.length) > (analysisResults === null || analysisResults === void 0 ? void 0 : analysisResults.length) || ((_b = foldersToRunCheck === null || foldersToRunCheck === void 0 ? void 0 : foldersToRunCheck.length) !== null && _b !== void 0 ? _b : 0) > (filesToUpload === null || filesToUpload === void 0 ? void 0 : filesToUpload.length)) {
                    this.logger.exit("The risks analysis process completed with errors, please check action's logs: " + commentUrl);
                }
                else if (analysisResults === null || analysisResults === void 0 ? void 0 : analysisResults.some((response) => { var _a, _b; return (response === null || response === void 0 ? void 0 : response.additions) && ((_b = (_a = response === null || response === void 0 ? void 0 : response.additions) === null || _a === void 0 ? void 0 : _a.analysis_result) === null || _b === void 0 ? void 0 : _b.length) > 0; })) {
