...
class Github {
    ...
    createComment(options) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.octokit.rest.issues.createComment(Object.assign(Object.assign({}, github_1.context.repo), { issue_number: github_1.context.issue.number, body: options.comment }));
        });
    }
