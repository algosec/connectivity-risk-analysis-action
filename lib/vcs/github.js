...
${CODE_BLOCK}\n
    ...
    parseCodeAnalysis(analysis, terraform) {
        ...
        analysis.forEach(folderAnalysis => commentBodyArray.push((!(folderAnalysis === null || folderAnalysis === void 0 ? void 0 : folderAnalysis.additions)) ? '' : this.convertToMarkdown(folderAnalysis === null || folderAnalysis === void 0 ? void 0 : folderAnalysis.additions, terraform)));
