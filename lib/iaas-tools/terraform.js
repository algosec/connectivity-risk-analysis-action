        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const asyncIterable = (iterable, action) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (const [index, value] of iterable === null || iterable === void 0 ? void 0 : iterable.entries()) {
                    const relativePath = (_a = value === null || value === void 0 ? void 0 : value.replace(workDir, "")) === null || _a === void 0 ? void 0 : _a.substring(1);
                    const output = yield action({ runFolder: relativePath == "" ? "[Root]" : relativePath, workDir, path: value }, this.vcs);
                    const file = {
                        uuid: uuid.v4(),
