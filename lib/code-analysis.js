...
class AshCodeAnalysis {
    ...
    setSecrets() {
        ...
        this.apiUrl = (inputs === null || inputs === void 0 ? void 0 : inputs.CF_API_URL) ? inputs === null || inputs === void 0 ? void 0 : inputs.CF_API_URL : "https://api-feature-cs-0015342.dev.cloudflow.algosec.com/cloudflow/api/devsecops/v1";
