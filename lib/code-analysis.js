...
class AshCodeAnalysis {
    ...
    setSecrets() {
        ...
        this.apiUrl = (_a = inputs === null || inputs === void 0 ? void 0 : inputs.CF_API_URL) !== null && _a !== void 0 ? _a : "https://api-feature-cs-0015342.dev.cloudflow.algosec.com/cloudflow/api/devsecops/v1";
        this.loginAPI = (_b = inputs === null || inputs === void 0 ? void 0 : inputs.CF_LOGIN_API) !== null && _b !== void 0 ? _b : "https://dev.app.algosec.com/api/algosaas/auth/v1/access-keys/login";
