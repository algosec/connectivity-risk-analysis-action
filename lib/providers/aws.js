...
class AwsProvider {
    ...
    uploadToS3(tenantId, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const getPresignedUrl = `https://kqz04uqejd.execute-api.us-east-1.amazonaws.com/dev/cloudflow/api/devesecops/v1/presignedurl?tenantId=${tenantId}&actionId=${this.actionUuid}&owner=${github_1.context.repo.owner}`;
