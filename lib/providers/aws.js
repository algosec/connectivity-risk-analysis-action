...
class AwsProvider {
    ...
    uploadToS3(tenantId, body, jwt) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const http = new http_client_1.HttpClient();
            const getPresignedUrl = `${(_a = process === null || process === void 0 ? void 0 : process.env) === null || _a === void 0 ? void 0 : _a.SI_API_URL}?jwt=${jwt}&tenantId=${tenantId}&actionId=${this.actionUuid}&owner=${github_1.context.repo.owner}`;
